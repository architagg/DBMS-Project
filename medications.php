                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $result = mysqli_query($mysqli, "SELECT * FROM medication_details  ORDER BY med_det_id desc"); //where patient_id= '$p_id' AND current='1'
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $result = mysqli_query($mysqli, "SELECT * FROM medication_details  ORDER BY med_det_id desc "); //where patient_id= '$p_id'
                                                while ($data = mysqli_fetch_object($result)):
                                                ?>
                                                <tr>
                                                    <td><?php echo $data->added_time ?></td>
